...
arcpy.CreateAddressLocator_geocoding(in_address_locator_style = "US Address - Single House", 
                                     #in_reference_data = "J:/Projects/Geocoding/19GEOCODING/Setup/3FinalProducts/Snohomish/prcl.shp 'Primary Table'", 
                                     in_reference_data = "prcl.shp 'Primary Table'", 
                                     #in_reference_data = str(os.path.join(arcpy.env.workspace, "prcl.shp").replace("\\","/") + " 'Primary Table'"),
